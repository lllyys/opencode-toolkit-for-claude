---
description: Root cause analysis for user-described bugs using OpenCode
...
### Step 3: Deep Analysis with OpenCode
...
- **Use `mcp__opencode__opencode_ask`** (analysis is read-only)
...
**Model**: {chosen_model}
**Session ID**: `{sessionId}` _(use `/continue {sessionId}` to drill deeper)_
